...
export const TopRated = ({ skip, setSkip, setTotal, total }: Props) => {
  ...
  return (
    <div
      className="relative w-full max-w-7xl mx-auto px-4 md:px-10 transition-colors duration-300"
              ...
              <button
                ...
                className={`h-10 w-10 rounded-xl text-sm font-bold transition-all ${
                  currentPage === p
                    ...
                    : "border border-zinc-200 dark:border-zinc-700 hover:border-indigo-500"
                }`}
              >
                {p}
              </button>
