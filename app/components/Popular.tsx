  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        // Нийт хуудасны тоог (жишээ нь 500) хадгалах
    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-6 gap-y-10 place-items-center">
        {visibleMovies.map((movie) => (
          ...
          >
            <div className="relative w-full aspect-[2/3] overflow-hidden rounded-2xl shadow-lg bg-zinc-900">
              {movie.poster_path ? (
                <img
            ...
            <div className="w-full px-1">
              ...
              <h3 className="text-white font-bold text-base md:text-lg line-clamp-1 group-hover:text-indigo-400 transition-colors">
                {movie.title}
              </h3>
